module.exports = {
    ...
    crafts: [
    	{item: 1, type: 2, craft_lvl: 1, craft_items: [
    		{item: 3, type: 1, colvo: 20},
    		{item: 4, type: 1, colvo: 5}
    	]},
        {item: 2, type: 2, craft_lvl: 1, craft_items: [
        	{item: 3, type: 1, colvo: 50},
        	{item: 4, type: 1, colvo: 15}
        ]},

        {item: 1, type: 3, craft_lvl: 1, craft_items: [
        	{item: 3, type: 1, colvo: 25},
        	{item: 4, type: 1, colvo: 10},
        	{item: 7, type: 1, colvo: 5}
        ]},
        {item: 2, type: 3, craft_lvl: 1, craft_items: [
        	{item: 3, type: 1, colvo: 60},
        	{item: 4, type: 1, colvo: 20},
        	{item: 7, type: 1, colvo: 10}
        ]},

        {item: 1, type: 4, craft_lvl: 1, craft_items: [
        	{item: 4, type: 1, colvo: 10},
        	{item: 7, type: 1, colvo: 5},
        	{item: 6, type: 1, colvo: 1}
        ]},
        {item: 2, type: 4, craft_lvl: 1, craft_items: [
        	{item: 4, type: 1, colvo: 15},
        	{item: 7, type: 1, colvo: 10},
        	{item: 6, type: 1, colvo: 4}
        ]},
        {item: 3, type: 4, craft_lvl: 1, craft_items: [
        	{item: 4, type: 1, colvo: 25},
        	{item: 8, type: 1, colvo: 5},
        	{item: 6, type: 1, colvo: 6}
        ]},
        {item: 4, type: 4, craft_lvl: 1, craft_items: [
        	{item: 4, type: 1, colvo: 25},
        	{item: 8, type: 1, colvo: 10}
        ]},
        {item: 5, type: 4, craft_lvl: 2, craft_items: [
        	{item: 3, type: 1, colvo: 20},
        	{item: 4, type: 1, colvo: 30},
        	{item: 8, type: 1, colvo: 20}
        ]},

        {item: 6, type: 1, craft_lvl: 1, craft_items: [
        	{item: 5, type: 1, colvo: 3}
        ]},
        {item: 8, type: 1, craft_lvl: 1, craft_items: [
        	{item: 7, type: 1, colvo: 5}
        ]},
        {item: 9, type: 1, craft_lvl: 1, craft_items: [
        	{item: 4, type: 1, colvo: 1},
        	{item: 6, type: 1, colvo: 1},
        	{item: 7, type: 1, colvo: 1}
        ]},
    ],
    locs: {
    	1: {
